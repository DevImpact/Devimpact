...
public class DesignPicsActivity extends AppCompatActivity implements YouTubePlayer.OnInitializedListener{
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean b) {
        ...
        if (!b) {
            mPlayer.cueVideo(getString(R.string.youtubeDesignPics_id));
        }
        else
        {
            mPlayer.play();
